...
WORKSPACE_CACHE_PAHT = '/home/yuxuan/.config/Code/User/workspaceStorage/'
...
def main() -> None:
    print('start clean...')
    folders: list[str] = [WORKSPACE_CACHE_PAHT+entry for entry in os.listdir(WORKSPACE_CACHE_PAHT) if os.path.isdir(WORKSPACE_CACHE_PAHT+entry)]
